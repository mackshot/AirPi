...
class hmc5883l:
    ...
    def __init__(self, bus=1, address=0x1E, gauss=1.3, declination=(0,0)):
        ...
        self.bus.write_byte_data(self.address, 0x00, 0b11110000) # 8 Average, 15 Hz, normal measurement
